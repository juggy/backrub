(function() {
  ...
  Backrub = {
    ...
    _resolveIsModel: function(attr, model) {
      var is_model;
      is_model = false;
      attr = attr && ((typeof attr.charAt === "function" ? attr.charAt(0) : void 0) === "@") ? (is_model = true, model = model.model, attr.substring(1)) : attr && model && model.get && model.get(attr) !== void 0 ? (is_model = true, attr) : attr && model.model && model.model.get && model.model.get(attr) !== void 0 ? (is_model = true, model = model.model, attr) : model[attr] !== void 0 ? attr : (model = null, is_model = null, attr);
      return {
        is_model: is_model,
        attr: attr,
        model: model,
  ...
  _ref = [Backbone.Model.prototype, Backbone.Router.prototype, Backbone.Collection.prototype, Backbone.View.prototype];
  for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    proto = _ref[_i];
    _.extend(proto, {
  ...
  _.extend(Backbone.Backrub.prototype, {
    ...
    makeAlive: function(base) {
      ...
      $(query.join(","), base).each(function() {
        ...
        view.el = el;
        view.delegateEvents();
        return (_ref2 = view.alive) != null ? _ref2.call(view) : void 0;
      });
  ...
  Handlebars.registerHelper("view", function(viewName, context) {
    var execContext, key, resolvedOptions, v, val, view, _ref2, _ref3;
    ...
    for (key in _ref2) {
      val = _ref2[key];
      resolvedOptions[key] = (_ref3 = Backrub._resolveValue(val, this)) != null ? _ref3 : val;
    }
